...
RSpec.describe "/coaches", type: :request do
  ...
  # CoachesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get coaches_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Coach" do
        expect {
          post coaches_url,
               params: { coach: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new coach" do
        post coaches_url,
             params: { coach: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested coach" do
        coach = Coach.create! valid_attributes
        patch coach_url(coach),
              params: { coach: new_attributes }, headers: valid_headers, as: :json
        coach.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the coach" do
        coach = Coach.create! valid_attributes
        patch coach_url(coach),
              params: { coach: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the coach" do
        coach = Coach.create! valid_attributes
        patch coach_url(coach),
              params: { coach: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested coach" do
      coach = Coach.create! valid_attributes
      expect {
        delete coach_url(coach), headers: valid_headers, as: :json
      }.to change(Coach, :count).by(-1)
    end
  end
end
